...
Route::get('/payment_notification', function () {
    return view('payment_notification');
});

Route::get('/order_history', 'FrontEndController@order_history')->name('order_history');

Route::get('/', 'FrontEndController@index')->name('front');
Route::get('/'.env('URL_ROUTE','restaurant').'/{alias}', 'FrontEndController@restorant')->name('show.vendor');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    //novi ruti Tommy
    Route::get('/profile/my_restaurants', 'ProfileController@my_restaurants')->name('my_restaurants');
    Route::get('/profile/my_restaurant/{id}', 'ProfileController@my_restaurant')->name('my_restaurant');
    ...
    Route::delete('/delete-orders/{id}','OrderController@destroy')->name('delete-orders');
    Route::get('/operator_orders/{id}', 'OrderController@operator_orders')->name('operator_orders');
    ...
    Route::get('list/{restorant}', 'ItemsController@indexAdmin')->name('admin.items');
...
Route::post('/order', 'OrderController@store_online_payment')->name('order.store');

//Route::post('/charge', 'OrderController@store_online_payment')->name('charge');
