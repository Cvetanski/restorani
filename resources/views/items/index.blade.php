...
@section('content')
    ...
    @include('items.partials.header', ['title' => 'Ажурирање на мени'])
...
{{--                                        <h3 class="mb-0">{{ __('Restaurant Menu Management') }}</h3>--}}
                                    ...
                                    <div class="col-auto">
                                        <button class="btn btn-icon btn-1 btn-sm btn-primary" type="button" data-toggle="modal" data-target="#modal-items-category" data-toggle="tooltip" data-placement="top" title="Add new category">
                                            <span class="btn-inner--icon"><i class="fa fa-plus"></i> Креирај категорија за мени</span>
                                        </button>
...
{{--                                                    <img class="card-img-top" src="{{ $item->logom }}" alt="...">--}}
                                                    <div class="card-body">
                                                        ...
                                                        <p class="mt-3 mb-0 text-sm">
                                                            @if($item->available == 1)
                                                            <span class="text-success mr-2">Достапен</span>
                                                            @else
                                                            <span class="text-danger mr-2">Недостапен</span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
