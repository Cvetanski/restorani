            ...
            foreach ($demoOrdersLast3Days as $key => $order) {
                ...
                if($order->id%10==0){
                    DB::table('order_has_status')->insert([
                        ...
                        'status_id' =>  8,
                        'user_id' => 1,
                        'comment' => 'Одбиена од администратор',
                        'created_at' => now(),
                        'updated_at' => now()
                    ]);
                }else{
                    ...
                    if($order->id%9!=0){
                        DB::table('order_has_status')->insert([
                            ...
                            'status_id' =>  2,
                            'user_id' => 1,
                            'comment' => 'Прифатена од администратор',
                            'created_at' => now(),
                            'updated_at' => now()
                        ]);
                            ...
                            if($order->id%2==0){
                                ...
                                if($order->id%4==0){
                                    DB::table('order_has_status')->insert([
                                        ...
                                        'status_id' =>  4,
                                        'user_id' => 1,
                                        'comment' => 'Доделена на доставувач',
                                        'created_at' => now(),
                                        'updated_at' => now()
                                    ]);
                                    $order->driver_id=3;
                                    ...
                                    DB::table('order_has_status')->insert([
                                        ...
                                        'status_id' =>  5,
                                        'user_id' => 1,
                                        'comment' => 'Подготвена од ресторан',
                                        'created_at' => now(),
                                        'updated_at' => now()
                                    ]);
