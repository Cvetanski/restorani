...
class FinanceController extends Controller
{
    ...
    public function adminFinances(){
        ...
        //CARDS
        $cards=[
            ['title'=>"Нарачки",'value'=>0],
            ['title'=>"Вкупно",'value'=>0,'isMoney'=>true],
            ['title'=>"Platform Fee",'value'=>0,'isMoney'=>true],    //ZA PREVEDUVANJE
            ['title'=>"Нето",'value'=>0,'isMoney'=>true],

            ['title'=>"Processor Fee",'value'=>0,'isMoney'=>true],   //ZA PREVEDUVANJE
            ['title'=>"Испорачки",'value'=>0],
            ['title'=>"Приход Од Испорачки",'value'=>0,'isMoney'=>true],
            ['title'=>"Профит",'value'=>0,'isMoney'=>true],
        ];
        foreach ($resources['orders']->get() as $key => $order) {
            $cards[0]['value']+=1;
    ...
    public function ownerFinances(){
        ...
        $cards=[
            ...
            ['title'=>"Вкупно",'value'=>0,'isMoney'=>true],
            ['title'=>"Platform Fee",'value'=>0,'isMoney'=>true],   //ZA PREVEDUVANJE
            ['title'=>"Net inc. Vat",'value'=>0,'isMoney'=>true],   //ZA PREVEDUVANJE

            ['title'=>"ДДВ",'value'=>0,'isMoney'=>true],
            ['title'=>"Нето",'value'=>0,'isMoney'=>true],
            ['title'=>"Испорацки",'value'=>0],
            ['title'=>"Цена На Испорачки",'value'=>0,'isMoney'=>true],
        ];
        foreach ($resources['orders']->get() as $key => $order) {
            $cards[0]['value']+=1;
            $cards[1]['value']+=$order->delivery_price+$order->order_price;
