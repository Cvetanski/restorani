    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-md-12 {{ $class ?? '' }}">
                <h1 style="display:inline"  class="display-2 text-white">Нарачки во живо</h1>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <!-- Title -->
              <h5 class="h3 mb-0">Нови нарачки</h5>
            </div>
            <!-- Card body -->
            <div class="card-body">
              <!-- List group -->
