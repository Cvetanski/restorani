...
class ItemsController extends Controller
{
    ...
    public function index()
    {
        if(auth()->user()->hasRole('owner')){
            ...
            return redirect()->route('orders.index')->withStatus('Немате пристап');
    }
    ...
    public function store(Request $request)
    {
        ...
        if(auth()->user()->hasRole('admin')){
            return redirect()->route('admin.items',['restorant'=>$item->category->restorant])->withStatus(__('Item successfully updated.'));
        }

        return redirect()->route('items.index')->withStatus('Оброкот е успешно додаден!');
    }
    ...
    public function edit(Items $item)
    {
        ...
        if(auth()->user()->hasRole('owner') && $item->category->restorant->id == auth()->user()->restorant->id || auth()->user()->hasRole('admin')){
            ...
            return redirect()->route('items.index')->withStatus('Немате пристап');
        }
    }
    ...
    public function update(Request $request, Items $item)
    {
        ...
        $item->update();
        return redirect()->route('items.edit', $item)->withStatus('Оброкот е успешно ажуриран');
    }
    ...
    public function destroy(Items $item)
    {
        ...
        return redirect()->route('items.index')->withStatus('Оброкот е успешно отстранет');
    }
    ...
    public function import(Request $request)
    {
        ...
        return back()->withStatus('Документот е успешно импортиран');
    }
    ...
    public function storeExtras(Request $request, Items $item)
    {
        ...
        return redirect()->route('items.edit',['item' => $item, 'restorant' => $item->category->restorant, 'restorant_id' => $item->category->restorant->id])->withStatus('Додатоците успешно додадени/модифирани.');
    }
    ...
    public function editExtras(Request $request, Items $item)
    {
        ...
        return redirect()->route('items.edit',['item' => $item, 'restorant' => $item->category->restorant, 'restorant_id' => $item->category->restorant->id])->withStatus('Додатоците успешно се ажурирани');
    }
    ...
    public function deleteExtras(Items $item, Extras $extras)
    {
        ...
        return redirect()->route('items.edit',['item' => $item, 'restorant' => $item->category->restorant, 'restorant_id' => $item->category->restorant->id])->withStatus('Додатоците успешно се отстранети.');
    }
}
