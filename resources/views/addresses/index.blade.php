                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Мои адреси</h3>
                            </div>
                            <!--<div class="col-4 text-right">
                                <button class="btn btn-icon btn-1 btn-sm btn-primary" type="button" data-toggle="modal" data-target="#modal-new-address" data-toggle="tooltip" data-placement="top">{{ __('Add New Address') }}</button>
                            </div>-->
                        </div>
                    </div>
                    ...
                    <div class="card-footer py-4">
                        ...
                        @else
                            <h4> Се уште немате внесено адреса...</h4>
                        @endif
                    </div>
                </div>
            </div>
